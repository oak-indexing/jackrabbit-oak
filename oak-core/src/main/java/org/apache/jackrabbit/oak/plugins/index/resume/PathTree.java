...
public class PathTree {
    ...
    public void serializeUltraSlimTo(@NotNull NodeBuilder builder) {
        ...
        log.debug("[PATHTREE-ULTRASLIM] Serialized: lastPath={}, inProgress={} paths, estimatedSize=~{} bytes (vs {} total nodes)",
            lastFullyProcessedPath, inProgressPaths.size(), estimatedSize, totalNodes);
    }
    ...
    public static PathTree deserializeUltraSlimFrom(@NotNull NodeState state) {
        ...
        log.debug("[PATHTREE-ULTRASLIM] Loaded: lastPath={}, inProgress={} paths, useDfsOrder={}",
            tree.lastFullyProcessedPath, inProgressCount, tree.useDfsOrderComparison);
