...
public class ElasticTestRepositoryBuilder{
    ...
    ElasticIndexProvider indexProvider;
    ...
    public ElasticTestRepositoryBuilder(NodeStoreType nodeStoreType, boolean isAsync) {
