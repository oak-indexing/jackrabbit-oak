...
public class ElasticIndexProviderService {
    ...
    public @interface Config {
        ...
        int port() default ElasticConnection.DEFAULT_PORT;
...
//                "TextExtraction statistics"));
    ...
    private ElasticConnection getElasticConnection(Config contextConfig) {
        ...
        final String indexPrefix = System.getProperty(PROP_INDEX_PREFIX, contextConfig.indexPrefix());
...
//        final String portS = (String) contextConfig.getOrDefault(PROP_ELASTIC_PORT,
//                "" + ElasticConnection.DEFAULT_PORT);
        final int port = Integer.getInteger(PROP_ELASTIC_PORT, contextConfig.port());
