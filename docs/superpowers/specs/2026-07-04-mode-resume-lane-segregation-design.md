...
### C-fallback toggle: `FT_RESUMABLE_REINDEXING_OAK-<issue>` (default off)
...
- `FT_RESUMABLE_REINDEXING_OAK-<issue>` — feature toggle, default off.
...
- Exact Jira issue number for the toggle name (`FT_RESUMABLE_REINDEXING_OAK-<issue>`).
